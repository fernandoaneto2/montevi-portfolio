        ...
        <section className="servico-hero">
          ...
          <div className="servico-hero__inner">
            ...
            <p className="servico-hero__subtitle">
              Projetamos, executamos e damos manutenção em subestações, sistemas
              de geração distribuída e redes elétricas — com domínio completo
              das normas e ferramentas da Energisa.
            </p>
          </div>
        </section>
